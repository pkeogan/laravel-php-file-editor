...
use PHPFile;
use Pkeogan\Support\Exceptions\NotImplementedYetException;
...
class DemoCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Pkeogan:demo';
     ...
     * @var string
     */
    protected $description = 'Provides a few interactive examples to illustrate Pkeogan capabilities';
    ...
    public function presentPathToSource()
    {
        ...
        $this->line('Review source: ' .
            base_path('vendor/ajthinking/Pkeogan/src/Commands/DemoCommand.php'));
    }
}
